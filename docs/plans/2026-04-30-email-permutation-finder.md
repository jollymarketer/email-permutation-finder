...
**Repo root:** `c:/Users/richa/Jolly_Claude_Code/email-permutation-finder/`
...
```
c:/Users/richa/Jolly_Claude_Code/email-permutation-finder/permutation_finder.py
```
...
python "c:/Users/richa/Jolly_Claude_Code/email-permutation-finder/permutation_finder.py" \
  --input leads.csv \
  --output found.csv \
  --dry-run
...
Full design at:
```
c:/Users/richa/Jolly_Claude_Code/email-permutation-finder/docs/specs/2026-04-30-email-permutation-finder-design.md
```
````
